    ...
    return (
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0c0a14]">
        ...
        <div className="relative flex flex-col items-center gap-4 text-center">
          ...
          <Link
            href="/results"
            className="mt-4 rounded-full bg-gradient-to-r from-orange-500 to-yellow-500 px-6 py-3 font-medium text-black transition-all hover:scale-105"
          >
            View Your Results
          </Link>
        </div>
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0c0a14]">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4">
        ...
        <div className="relative w-full max-w-sm">
          {/* Card glow */}
          <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-r from-orange-500/15 via-yellow-500/15 to-blue-500/15 blur-2xl" />
          ...
          <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 backdrop-blur-2xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative mb-6">
                {/* Glow behind album */}
                <div className="absolute -inset-4 rounded-2xl bg-gradient-to-br from-orange-500/20 via-yellow-500/20 to-blue-500/20 blur-2xl" />

                {/* Album container */}
                <div className="relative h-52 w-52 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm sm:h-60 sm:w-60">
                  {currentSong?.album_art_url ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-orange-500/10 via-transparent to-blue-500/10">
                ...
                {/* Animated ring */}
                <div
                  className="absolute -inset-1 rounded-2xl border border-orange-500/20"
                  style={{
              ...
              <div className="mb-8 flex flex-col items-center text-center">
                ...
                {currentSong?.genre && (
                  <span className="mt-3 rounded-full border border-orange-500/20 bg-orange-500/10 px-3 py-1 text-xs font-medium text-orange-300">
                    {currentSong.genre}
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  />
                  <div
                    className={`absolute -inset-1 rounded-full bg-red-500/40 blur-lg transition-opacity duration-300 ${
                ...
                >
                  ...
                  />
                  <div
                    className={`absolute -inset-1 rounded-full bg-blue-500/40 blur-lg transition-opacity duration-300 ${
                ...
                >
                  <div
                    className={`absolute inset-0 rounded-full border transition-all duration-300 ${
                      hoveredButton === "like"
                        ? "border-orange-500/50 bg-gradient-to-br from-orange-500/30 to-yellow-500/30"
                        : "border-white/10 bg-white/5"
                    }`}
                  />
                  <div
                    className={`absolute -inset-2 rounded-full bg-gradient-to-r from-orange-500/50 to-yellow-500/50 blur-xl transition-opacity duration-300 ${
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-[10%] top-[25%] h-2 w-2 rounded-full bg-orange-400/60" />
          <div className="absolute right-[15%] top-[20%] h-1.5 w-1.5 rounded-full bg-blue-400/60" />
          <div className="absolute bottom-[20%] left-[20%] h-1 w-1 rounded-full bg-yellow-400/60" />
          <div className="absolute bottom-[30%] right-[10%] h-2 w-2 rounded-full bg-cyan-400/60" />
        </div>
      </div>
